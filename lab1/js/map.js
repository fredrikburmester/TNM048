...
function worldMap(data) {
    ...
    // Q: Maybe tell us to use the div with id = mapid
    // Q: Why don't you tell us to set variable name ??
    ...
    // Q: Maybe specify object passthorugh?
    var transform = d3.geoTransform({
        point: projectPointsOnMap
    })

    // Q: Why is this variable wrong??
